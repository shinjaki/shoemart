...
// Fetch transactions with 'Pending' status, join with necessary tables to fetch customer name and product details
                          ...
                          <div class="card shadow mb-4">
                            <div class="card-body">
                                ...
                                <div class="pagination">
                                    ...
                                    if ($page > 1) {
                                        echo "<a href='pending_orders.php?page=" . ($page - 1) . "'>&laquo; Previous</a>";
                                    }

                                    // Display page numbers
                                    for ($i = 1; $i <= $total_pages; $i++) {
                                        $active = ($i == $page) ? "active" : "";
                                        echo "<a href='pending_orders.php?page=$i' class='$active'>$i</a>";
                                    }

                                    // Display next page link
                                    if ($page < $total_pages) {
                                        echo "<a href='pending_orders.php?page=" . ($page + 1) . "'>Next &raquo;</a>";
                                    }
                                    ?>
                                </div>
                            </div>
